...
public class CameraFollow : MonoBehaviour {
    ...
    [SerializeField] private CharacterController2D target;
    ...
    struct FocusArea
    {
        ...
        public FocusArea(Bounds targetBounds, Vector2 size)//create a focusArea, centred in the target, with size = size 
        {
